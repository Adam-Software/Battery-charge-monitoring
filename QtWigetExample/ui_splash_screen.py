...
class Ui_SplashScreen(object):
    def setupUi(self, SplashScreen):
        ...
        self.circularProgressBarBase.setGeometry(QRect(0, 10, 320, 320))
...
"color: rgb(155, 155, 255);")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.labelTitle.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p><span style=\" font-weight:600; color:#9b9bff;\">ADAM</span> BATTERY LEVEL</p></body></html>", None))
        ...
        self.labelCredits.setText(QCoreApplication.translate("SplashScreen", u"by: Robot LLC, 2022", None))
    # retranslateUi
